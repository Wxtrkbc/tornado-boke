class Pagenation:
    ...
    def generate_str_page(self, base_url):
        ...
        if self.current_page == 1:  # 上一页
            ...
            prev = '<li><a class="pre-page" href="%s%s">上一页</a></li>' % (
        ...
        if self.current_page == self.all_pages:  # 下一页
            ...
            nex = '<li><a class="next-page" href="%s%s">下一页</a></li>' % (
            base_url, self.current_page + 1,)
        ...
        page_info = '<div class="page-info"><span>{}/{} 页</span></div>'.format(self.current_page,
                                                                               self.all_pages)
